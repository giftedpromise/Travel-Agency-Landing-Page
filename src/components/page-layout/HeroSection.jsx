    ...
    <section className="mt-16 flex items-center justify-between md:z-[9999]">
      <div className="pt-32 md:pt-4">
        ...
        <div className="flex flex-col">
          <div className="volkhov leading-large inline-flex text-[2.5rem] font-[700] text-lightBlue md:text-[3rem] lg:text-[3.8rem]">
            Travel,
            <div className="flex flex-col">
          ...
          <p className="volkhov leading-large inline-flex text-[2.5rem] font-[700] text-lightBlue md:text-[3rem] lg:text-[3.8rem]">
